...
Private schools have the highest average SAT score with community colleges having the lowest average SAT score. The minimum scores of private schools are also the highest among the three groups and then the minimum scores of community colleges are the lowest among the three groups.
...
Yes, there is a significant difference in SAT scores across college types because the overall p-value  falls below the .001 significance level. Because the p-value is less than .001, this shows that there is a significant difference in SAT scores across college types. 
2. Which specific college types differ from each other?
All of the college types differ from one another with private and public colleges having the most significant difference when compared to the other differences as the p-value is much lower than the other p-values. 
3. How large are these differences?
Private colleges and public colleges have the biggest statistically significant difference as public colleges have SAT scores that are 74.40 points lower than private colleges and have the lowest p-value of .000021.

Headline:
Students at private colleges had the highest SAT scores

Lead:
Students at private colleges had an average SAT score of 1435 while community college students and public college students' average SAT scores fall below 1435. Community college students report the lowest average SAT score of 1068 while public college students' average SAT score is 1360.
