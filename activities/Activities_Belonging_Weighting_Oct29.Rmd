...
**YOUR NAME HERE:** Bella DeCrescenzo
...
One thing we found concerning was that people who identified as more than one ethnicity were lumped into a multi-ethnic category. Similarly, respondents that identify as transgender, genderfluid, non-binary, etc. were grouped under "gender exansive". Lumping these people into categories makes the findings less accurate. The last question I had was the fact that estimates based on less than 5 responses were completely redacted, which could throw findings off. 
...
The weights in this dataset range from .2298 to 3.0386.

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **Write your answer here:**
When a respondent has a weight of 0.23, it means that they were severely overrepresented. When a respondent has a weight of 3.0386, it means that the respondent was severely underrepresented. 

3. Why might some respondents be weighted more heavily than others? **Write your answer here:**
Some respondents might be weighted more heavily than others because less people within that category responded or were less likely to respond. 
...
These differences would not affect reporting on likely voter turnout as these people would not cause significant changes in the voter turnout.
...
These differences exist because the rarely/never voters not voting in the election were underrepresented in the population of people polled. Therefore, their findings were weighted and these differences exist. 
