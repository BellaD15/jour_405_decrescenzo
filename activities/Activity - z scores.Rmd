...
The only pattern I see is that the number of calls goes down a bit in the winter months and is at its highest in the summer months.
...
These unusual days show the outliers in the data. In task 3, we wrote that the number of calls seem to decrease during the winter months, and these months hold the most amount of unusually low number of calls.
...
Tuesday 10/4 is the day with the most number of outliers as the number of calls on this Tuesday is farthest away from the mean number of calls on Tuesdays (10.3).
...
Some potential angles for reporting would be figuring out why the winter months show a decrease in 911 calls, but October shows such a spike. I would tell my editor that I found that the month of October holds many outliers for 911 calls for overdoses but the number of calls throughout the winter months tends to dip. My next steps would be contacting the police department and also doctors who might be able to explain these occurrences. 
