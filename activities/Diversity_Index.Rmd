...
Baltimore City, Bowie City, and Edgewood all stand out as seemingly being some of the most diverse cities within this dataset.
...
Summerfield has the highest race probability because the majority of residents within this city are black, making there be a large probability that two people randomly chosen from this city will both be black.
...
I've noticed that the cities with the lowest Hispanic probability have the lowest race probability, meaning that these cities are very racially diverse. 
...
The three most diverse cities are Langley Park (in Prince George's County), Wheaton (in Montgomery County) and Adelphi (also in Prince George's County) while the least diverse place is Lake Shore, along Maryland's eastern shore. 
...
Headline:
How Langley Park has cultivated the most diverse city in Maryland 
Lede:
Out of all Maryland cities, Langley Park has the highest diversity index score, meaning that they are the city with the highest combined racial and ethnic diversity. 

I would talk to the city government and ask them about how the city has promoted diversity in the past and how they continue to enact policies/procedures that promote diversity. Basically trying to get to the bottom of how this city has achieved the highest diversity index value.
