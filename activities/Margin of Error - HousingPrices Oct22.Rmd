...
No, the headline is not statistically justified for any of the sample sizes because when taking the margin of error into account, none of the poll findings are definitely over 50%. Therefore, this headline would not be accurate when taking margin of error into account. An alternative headline that would be more accurate could be 'About Half of Population Polled Supports New City Policy.'
...
Data supports officials' claims that the input of a transit line has increased property prices in a local neighborhood.

The mean price of a house before the input of the transit line was $285,000 while the mean price of a house after the input of the transit line is $304,500. A statistical test found that these findings are highly probable.
