...
**Your answer**:
Wealth distribution in the United States might not be normally distributed due to the imbalance of wealth within the United States and the large amount of wealth held by such a small percent of people. Also housing prices might not be normally distributed with the few very expensive houses skewing the data to the right. A reporter should make it known to the reader if data is present that is skewing the overall findings. For wealth distribution, they should measure using the median rather than the mean to avoid averaging the skewed data. 
