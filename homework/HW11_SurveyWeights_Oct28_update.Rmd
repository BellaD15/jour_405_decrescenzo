...
Education levels in survey samples might differ from the general population due to factors such as access to phones/technology. Some people within the population who have attended high school or less might have lower incomes, causing them to have less access to phones or technology through which they would complete surveys. Therefore, those of lower education groups would tend to be underrepresented in survey samples.
...
Citizens without college degrees less likely to vote in upcoming election 
...
After applying weights, most percentages stayed the same except for the high school or less group, which showed the biggest changes of about 3% less in the yes category.

2. Why might the weighted results be considered more accurate than the unweighted results?

The weighted results might be considered more accurate than the unweighted results because they more accurately represent the total population and take into account any factors that make the sample not match the actual population distributions.
...
It's important for journalists to understand survey weighting when reporting on polls so they can report on the survey's findings as accurately as possible. If a journalist reports on unweighted polls, their story might be misleading and cause readers to have an incorrect prediction or analysis of the polls.

2. How might the differences between weighted and unweighted results affect how you would report on this data?
The differences between weighted and unweighted results might affect how I would report on this data as if there are great differences between the two, I might choose to report on the weighted results, which would be more representative of the true population and therefore more accurate to report to the public. 
...
I would want to know what characteristics or populations the weights were based on and how much the polls were weighted, therefore allowing me to get an understanding of if the weighted data is a more accurate representation of the population. 
