...
The percentage of unemployed voters and the percentage of white voters seem to be the most correlated variables with voter turnout. Median age and the percentage of voters who have a bachelors degree or higher are not correlated at all.  The percentage unemployed seems to have a strong negative linear relationship with the dependent variable while population does not seem to have a linear relationship with the dependent variable.
...
The population, percentage of voters who have a bachelor or higher, and the percentage of unemployed voters seem to be insignificant as they all have p-values higher than .05. With a multiple r-squared value of .85 and an adjusted r-squared value of .80, it is obvious that this model is a good fit as it is able to accurately predict turnout most of the time. Also, with a very small residual standard of error, the model hardly deviates from actual turnout, making this model a great fit and very useful.
...
The full model is significantly better than the others with the highest adjusted r-squared value. However, the next best model with the second highest adjusted r-squared value is the model looking at the relationship between turnout and the percentage of the population that is white.
...
I could use this analysis to cover a voter participation story by looking into which counties have the highest voter turnout rates and what are the biggest factors, or reasons why, they have the largest voter turnout rates. Therefore, I could use this analysis to explain to readers which factors, such as income, are most important in impacting voter turnout.