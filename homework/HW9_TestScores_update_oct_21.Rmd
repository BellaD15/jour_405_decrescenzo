...
Just looking at the score_data dataframe, test scores have improved. I can tell that they have improved because the mean of the test scores used to be 72.6, but the new scores don't fall below 73, meaning that the average has to have gone up and test scores have improved.
...
The mean of the new scores is over 3 points higher than the old mean, showing that there is a chance that the reading program might be working for the students. The standard deviation is also considerably lower within the new dataset, showing that the student's reading scores are consistently higher. While reporting, I might ask questions about other changes in the curriculum or the population that might also be contributing to these score increases.
...
How third-grade reading scores have changed over time
...
**Hypotheses:**
Null: The new reading program did not improve student's reading scores.
Alternative: The new reading program did improve student's reading scores.
...
The p-value tells me that there is a very good chance that the results are statistically significant since it is way less than .05. To describe it to a non-technical audience, I would say that my findings show that the new reading program most likely did increase children's reading scores.
...
Headline: Third graders' reading skills have improved across the district

Lead: Data supports the superintendent's claims that a new program has raised reading test scores among third graders in the district. 
...
You could track reading speed and also ensuring comprehension.
